...
export const TextMultiImage = ({ blok }: TextMultiImageProps) => {
  ...
  return (
    <section
      ...
      className={clsx(
        "flex flex-col max-w-[1283px] mx-auto w-full mb-[51px] md:mb-[41px] lg:mb-[72px] pl-4 pr-6 md:px-[50px] lg:px-0 gap-8",
        {
          "flex-col": isTop,
    ...
    >
      ...
      {textBlok && (
        <Text blok={textBlok} hasMarginBottom={false} className="!px-0" />
      )}
    </section>
  );
};
